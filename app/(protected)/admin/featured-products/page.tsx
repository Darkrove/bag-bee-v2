...
export default async function FeaturedProductsAdminPage() {
  ...
  const rows = getEntityMonthlyPerformance(result, "productCategory");

  return (
    <>
      <LayoutHeader
        heading="Featured Products"
        text="View month-by-month performance for all product categories."
      />
      <FeaturedPerformanceCards entityLabel="Product Category" rows={rows} />
    </>
  );
}
