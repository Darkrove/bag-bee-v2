			...
			<Popover>
				<PopoverTrigger asChild>
					<Button
						...
						variant={'outline'}
						className={cn(
							'mr-px h-[32px] w-[200px] justify-start rounded-r-none border-r !border-border p-2 text-left font-normal hover:bg-accent focus:bg-accent focus-visible:!ring-1 focus-visible:!ring-gray-400 dark:bg-muted dark:hover:opacity-80 sm:min-w-[235px]',
							!date && 'text-muted-foreground'
						)}
					>
						<CalendarIcon className={`mr-2 hidden size-4 sm:inline-block`} />
						{date?.from ? (
							date.to ? (
...
const currentDate = new Date()
		...
		>
			<SelectTrigger className="h-[32px] w-full min-w-[100px] rounded-l-none !border-border p-2 hover:bg-accent focus:ring-0 focus-visible:!ring-1 focus-visible:!ring-gray-400 dark:bg-muted dark:hover:opacity-80">
